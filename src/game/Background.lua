...
local bgPause = love.graphics.newImage("graphics/tilesets/tile/Highway_road (96 x 64).png")
...
function Background:drawGameground()
    love.graphics.draw(bgPause,-self.scaleX,0)
    love.graphics.draw(bgPause,-self.scaleY,0)
end
